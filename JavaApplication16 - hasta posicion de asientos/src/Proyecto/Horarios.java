...
public abstract class Horarios extends JFrame implements ActionListener { 
...
public void actionPerformed(ActionEvent e) {
    ...
    for (int i = 0; i < botones.length; i++) {
        if (e.getSource() == botones[i]) { // si el botón presionado es el i-ésimo
            ...
            Asientos asientos = new Asientos(pelicula, horarios[i]); // creamos una nueva instancia de la clase Asientos con el nombre de la película y el horario
